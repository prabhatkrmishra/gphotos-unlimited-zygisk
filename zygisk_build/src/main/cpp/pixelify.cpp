...
// Spoofing apps
static std::vector<std::string> P1 = {"com.google.android.apps.photos", "com.google.ar.core",
                                      "com.google.vr.apps.ornament"};
static std::vector<std::string> P5 = {"com.google.android.tts",
                                      "com.google.android.apps.wearables.maestro.companion",
                                      "com.nothing.smartcenter",
                                      "com.google.android.googlequicksearchbox:interactor"};
static std::vector<std::string> P6 = {"com.google"};
static std::vector<std::string> P7 = {"com.google.pixel.livewallpaper",
                                      "com.google.android.apps.subscriptions.red",
                                      "com.breel.wallpaper", "com.snapchat.android",
...
public:
    ...
    void postAppSpecialize(const AppSpecializeArgs *) override {
        switch (spoof_type) {
            case 0:
                // Unload module for non targeted apps
...
private:
    ...
    void injectBuild(const char *model1, const char *product1, const char *finger1) {
        ...
        if (build_class == nullptr) {
            ...
            LOGI("inject android.os.Build for %s with \nPRODUCT:%s \nMODEL:%s \nFINGERPRINT:%s",
                 package_name, product1, model1, finger1);
        }
        ...
        if (strcmp(finger1, "") != 0) {
            jfieldID finger_id = env->GetStaticFieldID(build_class, "FINGERPRINT",
                                                       "Ljava/lang/String;");
    ...
    void injectversion(const int inc_c) {
        ...
        if (build_class == nullptr) {
            LOGW("failed to inject android.os.Build.VERSION for %s due to build is null",
                 package_name);
            return;
        }
    ...
    void disablespoofinghack() {
        ...
        jclass pixel_prop_class = env->FindClass(
        ...
        jfieldID device_id = env->GetStaticFieldID(pixel_prop_class, "DEVICE",
                                                   "Ljava/lang/String;");
        if (device_id != nullptr) {
